            ...
            for order in orders:
                if order['status']:
                    ...
                    if order.get('integration'):
                        ...
                        payment_list = [(0, 0, {'currency': X.get('currency'), 'payment_method': X.get('method'),
                                'total_paid_amount': X.get('amount'), 'integration_id': self.integration_id.id, 'status': X.get('status')})for X in order.get('payments')]
                        ...
                        data = {
                            ...
                            'doc_type': 'National Registration Number',
                            ...
                            'doc_number': order.get('original_raw_data').get('national_registration_number'),
