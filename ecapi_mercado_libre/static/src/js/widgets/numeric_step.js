...
odoo.define("ecapi_mercado_libre.field", function(require) {
    "use strict";
    ...
    const NumericStep = FieldFloat.extend({
        ...
        init: function() {
            ...
            this._config = {
                ...
                ignore_value: this.nodeOptions.hasOwnProperty("ignore_value") ? Number(this.nodeOptions.ignore_value) : 0,
            };
        ...
        _doStep: function(mode) {
            ...
            if (mode === "plus") {
                ...
                if (cval == this._config.ignore_value)
                {
                   cval += this._config.step;
                }
            } else if (mode === "minus") {
