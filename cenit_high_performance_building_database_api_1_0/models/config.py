...
class CenitIntegrationSettings(models.TransientModel):
    ...
    def get_default_api_key(self, context=None):
        api_key = self.env['ir.config_parameter'].get_param(
            'odoo_cenit.high_performance_building_database_api_1_0.api_key', default=None
        )
    ...
    def set_api_key(self):
        ...
        for record in self.browse(self.ids):
            config_parameters.set_param (
                'odoo_cenit.high_performance_building_database_api_1_0.api_key', record.api_key or ''
            )
