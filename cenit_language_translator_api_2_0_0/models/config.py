...
COLLECTION_NAME = "language_translator_api_2_0_0"
...
class CenitIntegrationSettings(models.TransientModel):
    _name = "cenit.language_translator_api_2_0_0.settings"
    ...
    def get_default_username(self, cr, uid, ids, context=None):
        username = self.pool.get('ir.config_parameter').get_param(
            cr, uid, 'odoo_cenit.language_translator_api_2_0_0.username', default=None, context=context
        )
    ...
    def get_default_password(self, cr, uid, ids, context=None):
        password = self.pool.get('ir.config_parameter').get_param(
            cr, uid, 'odoo_cenit.language_translator_api_2_0_0.password', default=None, context=context
        )
    ...
    def set_username(self, cr, uid, ids, context=None):
        ...
        for record in self.browse(cr, uid, ids, context=context):
            config_parameters.set_param (
                cr, uid, 'odoo_cenit.language_translator_api_2_0_0.username', record.username or '',
                context=context
            )
    ...
    def set_password(self, cr, uid, ids, context=None):
        ...
        for record in self.browse(cr, uid, ids, context=context):
            config_parameters.set_param (
                cr, uid, 'odoo_cenit.language_translator_api_2_0_0.password', record.password or '',
                context=context
            )
