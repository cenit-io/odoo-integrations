...
COLLECTION_NAME = "core_api_v2_beta_2_0"
COLLECTION_VERSION = "0.1"
COLLECTION_PARAMS = {
    "On connection 'CORE API v2 beta 2.0 Connection' template parameter 'api_key'":'api_key',
}

class CenitIntegrationSettings(models.TransientModel):
    _name = "cenit.core_api_v2_beta_2_0.settings"
    ...
    def get_default_api_key(self, cr, uid, ids, context=None):
        api_key = self.pool.get('ir.config_parameter').get_param(
            cr, uid, 'odoo_cenit.core_api_v2_beta_2_0.api_key', default=None, context=context
        )
    ...
    def set_api_key(self, cr, uid, ids, context=None):
        ...
        for record in self.browse(cr, uid, ids, context=context):
            config_parameters.set_param (
                cr, uid, 'odoo_cenit.core_api_v2_beta_2_0.api_key', record.api_key or '',
                context=context
            )
