...
class CenitIntegrationSettings(models.TransientModel):
    ...
    def get_default_api_key(self, context):
        api_key = self.env['ir.config_parameter'].get_param(
            'odoo_cenit.transportation_laws_and_incentives_api_0_1_0.api_key', default=None
        )
    ...
    def set_api_key(self):
        ...
        for record in self.browse(self.ids):
            config_parameters.set_param (
                'odoo_cenit.transportation_laws_and_incentives_api_0_1_0.api_key', record.api_key or ''
            )
